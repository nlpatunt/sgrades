    ...
    try:
        ...
        for entry in leaderboard_data:
            leaderboard_entry = CompleteLeaderboardEntry(
                ...
                avg_quadratic_weighted_kappa=entry.get('avg_quadratic_weighted_kappa'),
                avg_pearson_correlation=entry.get('avg_pearson_correlation'),
                avg_mean_absolute_error=entry.get('avg_mean_absolute_error', 999.0),
                avg_f1_score=entry.get('avg_f1_score'),
